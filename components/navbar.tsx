...
export default function Navbar() {
  ...
  return (
    <header className="top-0 left-0 right-0 flex items-center justify-between w-full pt-5 px-6 z-10">
      ...
      <motion.nav initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.75, type: "spring", stiffness: 100, delay: 0.5 }} className="z-10 fixed left-1/2 -translate-x-1/2 flex gap-8 bg-background/20 rounded-full border px-6 py-2 backdrop-blur-md">
